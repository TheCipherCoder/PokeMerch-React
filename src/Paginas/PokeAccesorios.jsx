...
import { productos } from '../Json/productosAcesorio.json';
import { Productos } from '../componentes/Productos';
import Filtros from '../componentes/Filtros';
import { useThemeContext } from '../context/ThemeContext';

function PokeAccesorios() {
  ...
  return (
    <>
      ...
      <Filtros filtros={filtros} setFiltros={setFiltros} categorias={categoriasUnicas} titulo="PokeAccesorios" />
